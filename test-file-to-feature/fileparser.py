...
from GetAbstract import ProccessFile
from FeatureExtraction import TokenStemmer

def fileparser(filename):

    sample=ProccessFile(filename)
...
if __name__ == '__main__':
    sample_file1='sample_pubmed_result.xml'
    sample_file2='sample_pubmed_result2.xml'
    large_file = "pubmed_result.xml"
    ablist=fileparser(sample_file1)